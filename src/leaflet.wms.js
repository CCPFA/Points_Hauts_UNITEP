 ...
 */
 ...
 //\'(\b(https?|ftp|file):\/\/:\/\/inpn\.mnhn\.fr\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/i;
function replaceURLWithHTMLLinks(text) {
    var exp = /URL = '((https?|ftp|file):\/\/inpn\.mnhn\.fr\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])'/i;
	//console.log(exp)
    return text.replace(exp,"<a target='_blank' href='$1'>Cliquer ici</a>"); 
}
(function (factory) {
